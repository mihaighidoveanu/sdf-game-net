...
if __name__ == '__main__':
    ...
    model_layers = keras.models.Sequential([
        keras.layers.Dense(512, activation="relu", input_shape=(2 + embedding_size,)),
        ...
        for epoch in range(total_epochs):
            ...
            for font_i in range(font_count):
                ...
                for char_i in range(char_count):
                    ...
                    glyph_mask = np.where(train_X_glyph == char_i)[0] # These are the data points with (x, y, id==char_i)
    ...
    if plot_embeddings:
        ...
        # embeddings.project(out_dir, model.get_layer("font_embedding"), list(range(font_count)), font_names)
